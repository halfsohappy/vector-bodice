"""CLI for the trouser pattern.

Measurement arguments come from manifest.json (the same source the web
frontend uses).

    python -m patterns.trouser --waist_arc_front 7 --waist_arc_back 7 \
...
parser = argparse.ArgumentParser(
    prog="python -m patterns.trouser",
...
parser.add_argument("--prefix", type=str, default="trouser",
