"""CLI for the slack pattern.

Measurement arguments come from manifest.json (the same source the web
frontend uses).

    python -m patterns.slack --waist_arc_front 7 --waist_arc_back 7 \
...
parser.add_argument("--prefix", type=str, default="slack",
